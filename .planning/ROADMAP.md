...
- [ ] **Phase 1: Database Foundation & Security** - 모든 신규 테이블 생성, RLS 정책 적용, 보안 취약점 제거
- [ ] **Phase 2: Authentication** - OAuth 4종 연동, AuthContext Supabase 전환, 사용자 프로필 시스템
...
- [ ] 02-03-PLAN.md -- 회원 탈퇴 + 사용자 차단 (Edge Function soft delete, BlockContext 연동)
