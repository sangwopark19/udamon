...
// ─── Content Data ────────────────────────────────────────────
const INTRO = `우다몬 사용자 여러분 안녕하세요. 본 우다몬 이용약관("본 약관")은 주식회사 헤이디컴퍼니("회사", "당사", "저희")가 제공하는 우다몬 애플리케이션, 웹사이트 및 기타 온라인 제품과 서비스(총칭하여 "서비스")에 대한 사용자의 액세스 권한 및 이용에 적용됩니다.

우다몬은 KBO 야구를 사랑하는 팬들을 위한 포토 공유 및 커뮤니티 플랫폼이며, 즐겁고 안전한 환경을 위해 몇 가지 기본적인 규칙을 준수해야 합니다. 서비스를 이용하려면 반드시 본 약관에 동의해야 합니다. 본 약관에 동의하지 않으면 당사 서비스에 액세스하거나 서비스를 이용할 수 없습니다.`;

const SECTIONS: Section[] = [
  {
    title: '1. 서비스 액세스 권한',
    items: [
      { type: 'body', text: '만 14세 미만은 우다몬 서비스를 이용하거나 액세스할 수 없습니다. 서비스에 액세스하는 경우 모든 공지사항 및 추가 약관을 주의 깊게 읽어주시기 바랍니다.' },
  ...
  },
  {
    title: '2. 개인정보 보호',
    items: [
      { type: 'body', text: '우다몬의 개인정보처리방침은 귀하가 당사 서비스에 액세스하거나 서비스를 이용할 때 당사가 귀하의 정보를 수집, 이용, 공유하는 방식과 이유를 설명합니다. 귀하가 서비스를 이용하면 개인정보처리방침에 명시된 대로 해당 정보의 수집 및 이용에 동의한 것으로 간주됩니다.' },
    ],
  },
  {
    title: '3. 서비스의 이용',
    items: [
      ...
      { type: 'bullets', items: [
        '합법적인 앱 마켓(App Store, Google Play)을 통해 얻은 우다몬 애플리케이션을 귀하가 소유하거나 관리하는 모바일 기기에 설치하고 사용할 권리',
        '우다몬 서비스에 대한 개인적이며, 양도 불가능하고, 비독점적이며, 철회 가능하고, 제한적인 라이선스',
      ] },
  ...
  {
    title: '4. 우다몬 계정 및 계정 보안',
    items: [
      { type: 'heading', text: '4.1 계정 생성' },
      { type: 'body', text: '당사 서비스의 특정 기능을 이용하려면 우다몬 계정("계정")을 만들어야 합니다. 계정은 이메일 또는 소셜 로그인(Apple, Google, 카카오)을 통해 생성할 수 있습니다.' },
      { type: 'heading', text: '4.2 계정 보안' },
      { type: 'bullets', items: [
        '귀하의 계정과 관련된 모든 정보 및 사건에 대한 책임은 전적으로 귀하에게 있습니다.',
        '계정의 보안을 유지하고, 귀하의 허락 없이 누군가가 계정에 액세스한 사실을 발견하거나 의심되는 경우 즉시 우다몬에 고지해야 합니다.',
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'body', text: '우다몬은 사진 중심의 플랫폼으로, 이미지 콘텐츠에 대해 다음의 특별 규정이 적용됩니다.' },
      { type: 'bullets', items: [
        ...
        'KBO 관련 면책: 우다몬은 KBO와 공식 라이선스 관계가 없는 독립적인 팬 커뮤니티 플랫폼입니다. 서비스 내 콘텐츠는 KBO, 구단, 선수가 공식적으로 승인하거나 보증한 것이 아닙니다.',
      ] },
  ...
  },
  {
    title: '9. 커뮤니티 가이드라인',
    items: [
      { type: 'body', text: '우다몬은 모든 야구 팬을 위한 건전하고 존중적인 커뮤니티를 지향합니다. 다음 가이드라인은 본 약관의 일부로서 효력이 있습니다.' },
      { type: 'bullets', items: [
  ...
  },
  {
    ...
    items: [
      { type: 'body', text: '우다몬은 타인의 지식재산권을 존중하며 당사 서비스 사용자 또한 이를 존중하도록 규정하고 있습니다. 저희는 저작권을 침해하는 자료를 서비스에서 삭제하고, 반복적으로 저작권을 침해하는 사용자에 대해서는 적절한 경우에 계정을 해지하는 조치가 포함된 정책을 시행 중입니다.' },
  ...
  },
  {
    ...
    items: [
      { type: 'body', text: '저희는 귀하가 우다몬을 즐겁게 이용하길 바랍니다. 그러나 문제나 분쟁이 있을 경우 이의를 제기하고 당사와 비공식적으로 해결하기 위해 노력할 것이라는 데 동의해 주시기 바랍니다.' },
      { type: 'numbered', items: [
