...
export const MOCK_ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    body: '우다몬이 2026 KBO 시즌과 함께 정식 오픈합니다. 많은 이용 부탁드립니다.',
    type: 'notice',
    isPinned: true,
    createdBy: 'admin-001',
...
export const MOCK_SENT_NOTIFICATIONS: AdminNotification[] = [
  ...
  { id: 'notif-007', type: 'announcement', target: 'all', targetUserId: null, title: '공지: 2026 시즌 서비스 오픈!', body: '우다몬이 2026 KBO 시즌과 함께 정식 오픈합니다. 많은 이용 부탁드립니다.', sentBy: 'admin-001', isAuto: true, createdAt: '2026-03-01T00:00:00Z' },
...
export const MOCK_SITE_SETTINGS: SiteSettings = {
  siteName: '우다몬', siteDescription: 'KBO 야구 사진 공유 플랫폼', primaryColor: '#1B2A4A', logoUrl: 'https://picsum.photos/seed/logo/200/200',
};
